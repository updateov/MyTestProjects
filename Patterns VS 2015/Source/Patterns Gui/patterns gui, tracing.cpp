...
bool tracing::DoOnExportDlgCalculatedEntriesRequestEx(DATE intervalStart, DATE intervalEnd, double& meanContructions, int& meanBaseline, int& meanBaselineVariability, double& montevideo)
{
