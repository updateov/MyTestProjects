// CRIPatternsChart.cpp : Implementation of CRIPatternsChartApp and DLL registration.
...
const CATID CLSID_SafeItem = { 0x822d5cdc, 0x3062, 0x4c71, { 0x8f, 0xa5, 0x71, 0x56, 0xe3, 0x8b, 0x2f, 0x1c } };
...
CRIPatternsChartApp theApp;

const GUID CDECL BASED_CODE _tlid = { 0x46787600, 0x69FD, 0x4389, { 0x8F, 0x44, 0x6F, 0xBC, 0xDA, 0x4F, 0x61, 0xAB } };
...
const GUID CDECL BASED_CODE _ctlid = { 0x822d5cdc, 0x3062, 0x4c71, { 0x8f, 0xa5, 0x71, 0x56, 0xe3, 0x8b, 0x2f, 0x1c } };

// By default, timeout dialogs in 60 seconds
int CRIPatternsChartApp::s_TimeoutDialog = 1;

// CRIPatternsChartApp::InitInstance - DLL initialization
BOOL CRIPatternsChartApp::InitInstance()
{
	InitCommonControls();
	...
	if (bInit)
	{
		CRIPatternsChartCtrl::initialize_bitmaps();
	}
...
// CRIPatternsChartApp::ExitInstance - DLL termination
int CRIPatternsChartApp::ExitInstance()
{
