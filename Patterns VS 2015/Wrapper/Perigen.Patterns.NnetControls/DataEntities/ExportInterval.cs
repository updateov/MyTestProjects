...
namespace Perigen.Patterns.NnetControls.DataEntities
{
    ...
    public class ExportInterval 
    {
        ...
        [XmlElement("CalculatedComboConcept", typeof(ExportCalculatedComboEntity))]
        [XmlElement("CalculatedCheckboxGroupConcept", typeof(ExportCalculatedCheckboxGroupEntity))]
