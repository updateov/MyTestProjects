...
{    
    ...
    public class PatternsWPFAdapter : IPatternsWPFAdapter
    {
        public bool InitNavigationPanel(IntPtr parentHandle, int x, int y, int width, int height)
        {
            ...
            bool res = PatternsUIManager.Instance.InitNavigationPanel(parentHandle, x, y, width, height);
        ...
        {
            bool res = PatternsUIManager.Instance.InitExportButton(parentHandle, x, y, width, height);
        ...
        {
            PatternsUIManager.Instance.SetExportDialogParams(meanContractionInterval,
                                                             meanBaseline,
