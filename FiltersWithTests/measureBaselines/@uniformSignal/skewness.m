...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function skewSignal = skewness(this, width, extrapMethod)
if nargin<3
...
skewSamples = zeros(1, nSamples);
for i = 1:nSamples
    window = thisSamples(i : i + 2 * halfWidth);
    skewSamples(i) = skewness(window);
end
skewSignal = uniformSignal('', 1, length(skewSamples), skewSamples);
% figure;
% hold on;
