...
string utils::perform_server_request(string url)
{
...
string utils::perform_server_postrequest(string url, string payload)
{
	...
	try
	{
		...
		if (dwServiceType == AFX_INET_SERVICE_HTTPS)
		{
			...
			pServer->SetOption(INTERNET_OPTION_CONNECT_TIMEOUT, 5000);
