...
/*
 =======================================================================================================================
    If you do not wish to link with the windebug module, comment out the next include directive and uncomment the
    define directive. ;
...
class CGlobalAtom
{
	...
	public:
		...
		CGlobalAtom(void)
		{
			atom = GlobalAddAtom(TEXT("_Hyperlink_Object_Pointer_") TEXT("\\{AFEED740-CC6D-47c5-831D-9848FD916EEF}"));
		}
...
/*
 ...
 =======================================================================================================================
 */
BOOL CHyperLink::ConvertStaticToHyperlink(HWND hwndParent, UINT uiCtlId, LPCTSTR strURL)
{
...
/*
 ...
 =======================================================================================================================
 */
LRESULT CALLBACK CHyperLink::_HyperlinkParentProc(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
		...
		case WM_CTLCOLORSTATIC:
			{
				...
				CHyperLink *pHyperLink = (CHyperLink *) GetProp(hwndCtl, PROP_OBJECT_PTR);
				/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
				...
				if (pHyperLink)
				{
					...
					{
						// This is the most common case for static branch prediction optimization
...
/*
 =======================================================================================================================
    Function CHyperLink::_HyperlinkProc Note: Processed messages are not passed back to the static control procedure.
    It does work fine but be aware that it could cause some problems if the static control is already subclassed.
    Consider the example where the static control would be already subclassed with the ToolTip control that needs to
    process mouse messages. In that situation, the ToolTip control would not work as expected.
 =======================================================================================================================
 */
LRESULT CALLBACK CHyperLink::_HyperlinkProc(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
		...
		case WM_MOUSEMOVE:
			{
				...
				else
				{
					...
					SendMessage(hwnd, WM_SETFONT, (WPARAM) CHyperLink::g_UnderlineFont, FALSE);
	...
	return CallWindowProc(pHyperLink->m_pfnOrigCtlProc, hwnd, message, wParam, lParam);
}
...
void CHyperLink::createLinkCursor(void)
{
	...
	{
		/*
		 * There exist an alternative way to get the IDC_HAND by loading winhlp32.exe but
		 * I estimated that it didn't worth the trouble as IDC_HAND is supported since
		 * Win98. I consider that if a user is happy with 10 years old OS, he won't bother
		 * to have an arrow cursor.
		 */
