	...
	public partial class Patterns : System.Web.UI.Page
	{
		...
		protected void Page_Load(object sender, EventArgs e)
		{
			...
			if (!PatternsWebSiteSettings.Instance.PatternsEnabled)
			{
				...
				Response.Write("<div style=\"border: 2px solid #000000; padding: 2px 10px 10px 10px; margin: 10px; background: #FFFFFF;\"><h1>PeriCALM® Patterns™</h1><br/><h2><span style='color:red'>PeriCALM® Patterns™ is not enabled.</span></h2></div>");
				Response.End();
				return;
			}
			...
			if (String.IsNullOrEmpty(inputData))
			{
				...
				{
					Response.Write("<div style=\"border: 2px solid #000000; padding: 2px 10px 10px 10px; margin: 10px; background: #FFFFFF;\"><h1>PeriCALM® Patterns™</h1><br/><h2><span style='color:red'>You are not authorized to see this page.</span></h2></div>");
					Response.End();
					return;
				}
