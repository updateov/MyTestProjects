	...
	public partial class Chalkboard : System.Web.UI.Page
	{
		...
		protected void Page_Load(object sender, EventArgs e)
		{
			...
			if (!IsPostBack)
			{
				...
				{
					Response.Write("<center><span style=\"font-weight: bold;font-size: 22px;font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;color: #FEFFFF;\">PeriGen PeriCALM® Patterns™ Chalkboard</span><br /><br /><br /><br /><span style=\"font-weight: bold;font-size: 22px;font-family: 'Lucida Sans Unicode', 'Lucida Grande', Sans-Serif;color: #FF0000;\">You are not authorized to see this page.</span></center>");
					return;
				}
