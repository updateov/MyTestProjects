...
!define APPNAME "PeriCALM Patterns Research"
!define APPNAMEANDVERSION "${APPNAME} ${VERSION}"

; Main Install settings
Name "PeriCALM® Patterns™ Research"
...
!define MUI_FINISHPAGE_RUN "$INSTDIR\RetrospectivePatternsResearch.exe"
...
Section "${APPNAME}" Section1
	...
	SetOutPath "$INSTDIR\"
	File "..\..\Release\RetrospectivePatternsResearch.exe"
	...
	CreateShortCut "$DESKTOP\${APPNAME}.lnk" "$INSTDIR\RetrospectivePatternsResearch.exe"
	CreateShortCut "$STARTMENU\${APPNAME}.lnk" "$INSTDIR\RetrospectivePatternsResearch.exe"
	CreateDirectory "$SMPROGRAMS\${APPNAME}"
	CreateShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\RetrospectivePatternsResearch.exe"
...
Section -FinishSection
	...
	WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\${APPNAME}" "DisplayName" "PeriCALM Patterns Research"
	...
	WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\${APPNAME}" "DisplayIcon" "$INSTDIR\RetrospectivePatternsResearch.exe"	
...
Section Uninstall
	...
	Delete "$INSTDIR\RetrospectivePatternsResearch.exe"
...
Function .onInit
    push "RetrospectivePatternsResearch.exe"
