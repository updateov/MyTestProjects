...
public:
	...
	bool DoOnExportDlgCalculatedEntriesRequestEx(DATE intervalStart, DATE intervalEnd, double& meanContructions, double& meanBaseline, double& meanBaselineVariability, double& montevideo);
protected:
