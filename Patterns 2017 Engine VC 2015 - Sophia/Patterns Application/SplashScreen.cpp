// SplashScreenEx.cpp : implementation file by John O'Byrne 01/10/2002
#include "stdafx.h"
...
/*
 ...
 =======================================================================================================================
 */
BOOL CSplashScreen::Create(CWnd *pWndParent, LPCTSTR szText, DWORD dwTimeout, DWORD dwStyle)
{
...
/*
 ...
 =======================================================================================================================
 */
BOOL CSplashScreen::SetBitmap(UINT nBitmapID, short red, short green, short blue)
{
	/*~~~~~~*/
	BITMAP bm;
	/*~~~~~~*/
...
/*
 ...
 =======================================================================================================================
 */
BOOL CSplashScreen::SetBitmap(LPCTSTR szFileName, short red, short green, short blue)
{
	/*~~~~~~~~~*/
	BITMAP bm;
	HBITMAP hBmp;
...
/*
 ...
 =======================================================================================================================
 */
void CSplashScreen::SetTextFont(LPCTSTR szFont, int nSize, int nStyle)
{
	/*~~~~~~~*/
	LOGFONT lf;
	/*~~~~~~~*/
...
/*
 ...
 =======================================================================================================================
 */
void CSplashScreen::SetTextDefaultFont(void)
{
	/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
	LOGFONT lf;
...
/*
 ...
 =======================================================================================================================
 */
void CSplashScreen::SetText(LPCTSTR szText)
{
	m_strText = szText;
	RedrawWindow();
}
...
/*
 ...
 =======================================================================================================================
 */
void CSplashScreen::SetTextColor(COLORREF crTextColor)
{
...
/*
 ...
 =======================================================================================================================
 */
void CSplashScreen::SetTextRect(CRect &rcText)
{
	m_rcText = rcText;
	RedrawWindow();
}
...
/*
 ...
 =======================================================================================================================
 */
void CSplashScreen::SetTextFormat(UINT uTextFormat)
{
...
/*
 ...
 =======================================================================================================================
 */
HRGN CSplashScreen::CreateRgnFromBitmap(HBITMAP hBmp, COLORREF color)
{
	...
	/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
	// selects the bitmap in the device context
	...
	INT j;					// current position in mask image
	...
	for (i = 0; i < bm.bmHeight; i++)
	{
		for (j = 0; j < bm.bmWidth; j++)
		{
			...
			// place part of scan line as RECT region if transparent color found after mask
			// color or mask color found at the end of mask image
	...
	// HRGN hRgn = ExtCreateRegion( NULL, RDHDR + pRgnData->nCount * sizeof(RECT),
	// (LPRGNDATA)pRgnData );
	// ;
...
/*
 ...
 =======================================================================================================================
 */
void CSplashScreen::DrawWindow(CDC *pDC)
{
	/*~~~~~~~~~~~~~~~~*/
	CDC memDC;
	CBitmap *pOldBitmap;
...
// =======================================================================================================================
//
BOOL CSplashScreen::OnEraseBkgnd(CDC *)
{
	return TRUE;
}
...
/*
 ...
 =======================================================================================================================
 */
LRESULT CSplashScreen::OnPrintClient(WPARAM wParam, LPARAM)
{
	/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
...
/*
 ...
 =======================================================================================================================
 */
void CSplashScreen::OnTimer(UINT)
{
	KillTimer(0);
	Hide();
}
...
/*
 ...
 =======================================================================================================================
 */
void CSplashScreen::PostNcDestroy(void)
{
	CWnd::PostNcDestroy();
	delete this;
}
...
/*
 ...
 =======================================================================================================================
 */
void CSplashScreen::OnClose(void)
{
}
