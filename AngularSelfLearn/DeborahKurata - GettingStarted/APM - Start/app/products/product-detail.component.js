...
var ProductDetailComponent = (function () {
    function ProductDetailComponent(m_activatedRoute, m_router, m_productService) {
        this.m_activatedRoute = m_activatedRoute;
    ...
    ProductDetailComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.m_sub = this.m_activatedRoute.params.subscribe(function (params) {
            var id = +params['id'];
            _this.getProduct(id);
        });
    };
    ...
    ProductDetailComponent.prototype.getProduct = function (id) {
        var _this = this;
        this.m_productService.getProduct(id).subscribe(function (product) { return _this.product = product; }, function (error) { return _this.errorMessage = error; });
    };
