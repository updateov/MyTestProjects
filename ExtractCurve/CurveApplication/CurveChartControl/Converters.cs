	...
	public class FirstExamConverter : IValueConverter
	{
		...
		public object Convert(object value, Type targetType, object parameter, System.Globalization.CultureInfo culture)
		{
			...
			try
			{
				...
				if (exam.IsFirstExam) 
					return Application.Current.Resources["ColumnCellFormatSelected"] as Style;

				if (exam.Status == Exam.CurveCalculationStatuses.Ignored) 
					return Application.Current.Resources["ColumnCellFormatNoSelected"] as Style;
			...
			return Application.Current.Resources["ColumnCellFormat"] as Style;
		}
