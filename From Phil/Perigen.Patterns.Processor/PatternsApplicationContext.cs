...
namespace Perigen.Patterns.Processor
{
    ...
    public class PatternsApplicationContext : ApplicationContext, IPatternsProcessorMessages
    {
        ...
        const int PatternsProcessorInactivityTimerSec = 20*60;
        ...
        public PatternsApplicationContext(String guid)
        {
            try
            {
                ...
                PatternsProcessorSettings.Source.TraceEvent(TraceEventType.Verbose, 210, "PAW debug: Patterns Processor (PID={0}, GUID={1}): PatternsProcessorInactivityTimerSec: {2}",
                    PatternsProcessorSettings.Instance.ProcessId, PatternsProcessorSettings.Instance.ProcessGUID, PatternsProcessorInactivityTimerSec);
