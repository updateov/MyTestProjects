...
namespace PeriCALM.Patterns.Curve.UI.Chart
{
	...
	public partial class PageMain : Page
	{
		...
		void PageLoaded(object sender, RoutedEventArgs e)
		{
			...
			{
				//debug
                string[] query = "service=http://bigentini:7802/PatternsDataFeed/&curve_client_refresh=5&banner=0&curve_review_mode_enabled=True&PODI_send_epidural=False&PODI_send_vbac=False&PODI_send_vaginaldelivery=False&user_name=PeriGen Support&user_id=PeriGen&can_modify=True&can_print=True&visit_key=123-18-1-1".Split('&');
			...
			//Set language
			Statics.AppResources.LanguageManager.SetDefaultLanguage("english"); // Default language, to be changed when it will (if it will) support multi language

			//Application title
			this.Title = Statics.AppResources.LanguageManager.TextTranslated["ApplicationTitle"];
		...
		void btnAbout_Click(object sender, RoutedEventArgs e)
		{
            ...
            btnOkAbout.Content = Statics.AppResources.LanguageManager.TextTranslated["AboutButtonOkTitle"];
		...
		private void SetTheme()
		{
			for (int i = 0; i < Application.Current.Resources.MergedDictionaries.Count; i++)
			{
				...
				if ((dic.Source == null) || dic.Source.OriginalString.ToLower().Contains("themes/theme"))
				{
					...
					Application.Current.Resources.MergedDictionaries.Insert(i, Application.LoadComponent(new Uri("PeriCALM.Patterns.Curve.UI.Chart;component/Themes/Theme" + currentTheme + ".xaml", UriKind.Relative)) as ResourceDictionary);
					break;
				}
			}
		}
		...
		void WorkerDoWork(object sender, DoWorkEventArgs e)
		{
			...
			if (string.IsNullOrEmpty(ServiceURL)) 
				throw new ArgumentException(Statics.AppResources.LanguageManager.TextTranslated["ErrorNOUrl"]);
