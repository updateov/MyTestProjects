...
namespace CurveChartControl
{
	public class AboutData
	{
        ...
        public string AboutPOB { get; set; }
		...
		public AboutData(bool isPeriCALM)
		{
			IntendedUseTitle = AppResources.LanguageManager.TextTranslated["AboutIntendedUseTitle"];
            IntendedUse = isPeriCALM ? AppResources.LanguageManager.TextTranslated["AboutIntendedUsePeriCALM"] : AppResources.LanguageManager.TextTranslated["AboutIntendedUsePeriWatch"];
			ProductInformationTitle = AppResources.LanguageManager.TextTranslated["AboutProductInformationTitle"];
            ProductInfo = isPeriCALM ? AppResources.LanguageManager.TextTranslated["AboutProductInfoPeriCALM"] : AppResources.LanguageManager.TextTranslated["AboutProductInfoPeriWatch"];
            ...
            ProductUDINumber = isPeriCALM ? AppResources.LanguageManager.TextTranslated["AboutProductUDINumberPeriCALM"] : AppResources.LanguageManager.TextTranslated["AboutProductUDINumberPeriWatch"];
            ProductCopyright = "Copyright PeriGen, Inc. 1997-2017. All rights reserved.";
            ProductPatentsDisclaimer = isPeriCALM ? AppResources.LanguageManager.TextTranslated["AboutProductPatentsDisclaimerPeriCALM"] : AppResources.LanguageManager.TextTranslated["AboutProductPatentsDisclaimerPeriWatch"];
            ...
            AboutPOB = AppResources.LanguageManager.TextTranslated["AboutPOB"];
