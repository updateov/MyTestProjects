...
namespace PeriGen.Patterns.WebSite.common
{
	public partial class Curve : System.Web.UI.Page
	{
		...
		protected void Page_Load(object sender, EventArgs e)
		{
			...
			{
				Response.Write("<div style=\"border: 2px solid #000000; padding: 2px 10px 10px 10px; margin: 10px; background: #FFFFFF;\"><h1>" + PatternsWebSiteSettings.Instance.BrandName + (PatternsWebSiteSettings.Instance.BrandMarkTM ? "™" : "®") + " Curve™</h1><br/><h2><span style='color:red'>" + PatternsWebSiteSettings.Instance.BrandName + (PatternsWebSiteSettings.Instance.BrandMarkTM ? "™" : "®") + " Curve™ is not enabled.</span></h2></div>");
				Response.End();
				return;
			}
