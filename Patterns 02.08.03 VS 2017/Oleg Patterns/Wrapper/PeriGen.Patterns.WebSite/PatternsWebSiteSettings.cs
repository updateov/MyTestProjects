    ...
    public class PatternsWebSiteSettings : ServiceSettings
    {
        ...
        public override bool UpdateEngineSettings()
        {
            ...
            try
            {
                ...
                ApplicationName = GetSettingsStrValue(NameOf<PatternsWebSiteSettings>.Property(e => e.ApplicationName));
                BrandName = GetSettingsStrValue(NameOf<PatternsWebSiteSettings>.Property(e => e.BrandName));
                String brandMarkStr = GetSettingsStrValue(NameOf<PatternsWebSiteSettings>.Property(e => e.BrandMarkTM));
                BrandMarkTM = Convert.ToBoolean(brandMarkStr);
                //Logo = GetSettingsIntValue(NameOf<PatternsWebSiteSettings>.Property(e => e.Logo));
