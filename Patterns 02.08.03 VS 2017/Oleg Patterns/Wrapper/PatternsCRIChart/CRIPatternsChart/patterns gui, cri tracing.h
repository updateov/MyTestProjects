...
namespace patterns_gui
{
	...
	*/
	...
	protected:
		...
		mutable int m_meanBaselineInCurWindow;
		mutable int m_meanVariabilityInCurWindow;
	...
	private:
		...
		void CountContractionsInRange(long ileft, long iright, long& numOfContractionsInCurWindow, long& totalContractionsPeakInCurWindow, long& numOfLongContractionsInCurWindow) const;
	public:
		CRITracing(void);
	...
	protected:
		void CalculateSummaryWindowColumnsRequiredWidth(CDC* dc, int& meanContractionTextW, int& meanContractionValueW,
