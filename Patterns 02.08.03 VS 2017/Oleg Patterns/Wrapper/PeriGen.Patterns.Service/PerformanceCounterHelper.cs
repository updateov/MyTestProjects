...
namespace PeriGen.Patterns.Service
{
	public static class PerformanceCounterHelper
	{
		...
		{
			Common.Source.TraceEvent(TraceEventType.Verbose, 2000, "Installing PeriCALM Patterns Service performance counters");
			...
			Common.Source.TraceEvent(TraceEventType.Verbose, 2005, "First time PeriCALM Patterns Service performance installation");
		}
		...
		public static void InitializePerformanceCounters()
		{
			...
			{	
				...
				Common.Source.TraceEvent(TraceEventType.Verbose, 2010, "Initialization of PeriCALM Patterns Service performance");
				...
				Common.Source.TraceEvent(TraceEventType.Verbose, 2015, "PeriCALM Patterns Service performance initialized");

				PerformanceCounterHelper.PerformanceCounterDisabled = false;
			}
			catch (Exception e)
			{
				Common.Source.TraceEvent(TraceEventType.Error, 2020, "PeriCALM Patterns Service performance cannot be initialized. Performance counter feature turned off.\nException: {0}", e);
