...
namespace PeriGen.Patterns.Service
{
    public class PatternsServiceSettings : ServiceSettings
    {
        ...
        public int PatternsProcessorMaxVisits { get; private set; }
        ...
        public bool BrandMarkTM { get; private set; }
        public int Logo { get; private set; }

        public bool Default15MinView { get; private set; }
        ...
        public override bool UpdateEngineSettings()
        {
            ...
            try
            {
                ...
                PatternsProcessorMaxVisits = GetSettingsIntValue(NameOf<PatternsServiceSettings>.Property(e => e.PatternsProcessorMaxVisits));
                ...
                ApplicationName = GetSettingsStrValue(NameOf<PatternsServiceSettings>.Property(e => e.ApplicationName));
                BrandName = GetSettingsStrValue(NameOf<PatternsServiceSettings>.Property(e => e.BrandName));
                String brandMarkStr = GetSettingsStrValue(NameOf<PatternsServiceSettings>.Property(e => e.BrandMarkTM));
                BrandMarkTM = Convert.ToBoolean(brandMarkStr);
                string logo = GetSettingsStrValue(NameOf<PatternsServiceSettings>.Property(e => e.Logo));
                Logo = Convert.ToInt32(logo);

                string strDefault15MinView = GetSettingsStrValue(NameOf<PatternsServiceSettings>.Property(e => e.Default15MinView));
                Default15MinView = Convert.ToBoolean(strDefault15MinView);
