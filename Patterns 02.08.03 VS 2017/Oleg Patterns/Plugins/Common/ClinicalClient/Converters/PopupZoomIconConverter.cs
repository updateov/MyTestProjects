...
{
    class PopupZoomIconConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            switch (status)
            {
                ...
                case CRIState.Off:
                    return (ControlTemplate)Application.Current.FindResource("IconZoomWhite");


                case CRIState.Negative:
                    return (ControlTemplate)Application.Current.FindResource("IconZoomGray");
